        ...
        <div className='bg-[#D9D9D9] h-[600px]'>
            <div className='max-w-[1440px] mx-auto p-8'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-10 gap-10'>
                    ...
                    <div className="relative h-96 rounded-3xl bg-[url('/img/mulher.jpg')] bg-cover bg-center bg-no-repeat">
                    ...
                    <div className="relative h-96 rounded-3xl bg-[url('/img/visto.jpg')] bg-cover bg-center bg-no-repeat">
                    ...
                    <div className="relative h-96 rounded-3xl bg-[url('/img/reserlva.jpg')] bg-cover bg-center bg-no-repeat">
                        <div className="absolute bottom-0 w-full min-h-[130px] p-3 bg-black/70 backdrop-blur-sm rounded-b-3xl flex flex-col justify-between">
                    ...
                    <div className="relative h-96 rounded-3xl bg-[url('/img/consultor.jpg')] bg-cover bg-center bg-no-repeat">
                        <div className="absolute bottom-0 w-full min-h-[130px] p-3 bg-black/70 backdrop-blur-sm rounded-b-3xl flex flex-col justify-between">
                            <div>
