...
function Card() {
    return (
        <div className='max-w-[1640px] mx-auto p-8 -mt-[50px] sm:mt-30  sm:mb-30  '>
            <p className='font-bold text-2xl text-center mb-15'> Bem-vindo à Panoramatours, Lda.</p>
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-20'>
                <div className="hidden sm:block h-full min-h-[400px] sm:p-2 md:p-2 rounded-2xl bg-[url('/img/homemafrica.jpg')] bg-cover bg-center bg-no-repeat flex" >
                </div>
                    ...
                    <div className="relative h-full sm:min-h-[400px] md:min-h-[200px] sm:p-2 md:p-2 rounded-2xl bg-[#D9D9D9] flex flex-col justify-between">
                        <div className=' mb-0'>
                            ...
                            <div className=' mt-4 mb-0 p-4'>
                                ...
                                <p className="text-[12px] sm:text-sm "> Do bilhete ao regresso, planeamos contigo, dos destinos mais próximos às aventuras internacionais, temos soluções à tua medida. Do primeiro contacto ao pós-viagem, estamos sempre ao teu lado. </p>
                            </div>
                        </div>
