...
export default function Banner() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center mt-[-50px] md:mt-[-250px]">
            ...
            <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 z-10 w-full max-w-[1640px] mx-auto">
